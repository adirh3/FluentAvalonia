    ...
    internal void SetupDialog()
    {
        ...
        switch (DefaultButton)
        {
            ...
            default:
                ...
                var next = (TopLevel.GetTopLevel(this)?.FocusManager?.FindNextElement(NavigationDirection.Next, new FindNextElementOptions { FocusedElement = this }) as Control) ?? this;
                next.Focus();
